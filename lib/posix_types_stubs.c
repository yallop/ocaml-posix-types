...
EXPOSE_TYPESIZE(pthread_barrier_t)
EXPOSE_TYPESIZE(pthread_barrierattr_t)
...
EXPOSE_TYPESIZE(pthread_spinlock_t)
EXPOSE_TYPESIZE(pthread_t)

EXPOSE_ALIGNMENT(pthread_attr_t)
EXPOSE_ALIGNMENT(pthread_barrier_t)
EXPOSE_ALIGNMENT(pthread_barrierattr_t)
...
EXPOSE_ALIGNMENT(pthread_spinlock_t)
